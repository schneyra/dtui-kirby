...
$link = "https://www.dertagundich.de";
$feedurl = "https://www.dertagundich.de/feed.xml";
$description = "Dies ist Martins Blog. Seit 2003. Alltäglich belangloses und so.";
$items = page('blog')->grandChildren()->children()->children()->flip()->limit(10);
$latest = $items->first();
$modified = date('r', $latest->date()->toTimestamp());
  ...
  <channel>
    ...
    <?php foreach ($items as $item): ?>
      <item>
        ...
        <description><![CDATA[<?php foreach ($item->text()->toBlocks() as $block) { echo $block; } ?>]]></description>
      </item>
    <?php endforeach; ?>
  </channel>
</rss>
